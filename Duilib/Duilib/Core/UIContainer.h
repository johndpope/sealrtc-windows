...
class CContainerUI;
class UILIB_API CContainerUIBuildCallback
{
public:
	virtual void BuildContainerUI(CContainerUI* container) = 0;
};
...
public:
	...
	bool RemoveNotDelete(CControlUI* pControl);
    ...
    virtual void SetInset(RECT rcInset); // set inset,set client
	...
	CContainerUIBuildCallback* GetBuildCallBack() const { return m_buildCallBack; }
	void SetBuildCallBack(CContainerUIBuildCallback* callback) { m_buildCallBack = callback; }
...
protected:
    ...
    bool m_bScrollProcess; // prevent the loop call of SetPos

    CScrollBarUI* m_pVerticalScrollBar;
    CScrollBarUI* m_pHorizontalScrollBar;

	CContainerUIBuildCallback* m_buildCallBack;
	bool m_isBuilded;
};
