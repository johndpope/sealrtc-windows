...
typedef bool (*PreTranslateMessage)(const LPMSG pMsg);
...
public:
	...
	void SetBackgroundTransparent2(bool bTrans);
    ...
    const TImageInfo* GetImageExWithAlpha(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);

    const TImageInfo* AddImage(LPCTSTR bitmap, HBITMAP hBitmap, int iWidth, int iHeight, bool bAlpha);
    const TImageInfo* AddImage(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
    const TImageInfo* AddImageWithAlpha(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0);
	...
	static void Term();
	static void setPreTranslateMessage(PreTranslateMessage hander){ m_preTranslateMessage = hander; }
...
private:
	...
	static PreTranslateMessage m_preTranslateMessage;
