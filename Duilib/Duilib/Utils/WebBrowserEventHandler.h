...
namespace DuiLib
{
	...
	public:
		...
		{
			//return E_NOTIMPL;
			//Return E_NOTIMPL normal pop-up system right-click menu
			return S_OK;
			//Return S_OK can shield the system menu
		}
		...
		virtual void WindowClientFunction1()
		{
		}

		virtual int WindowClientFunction2()
		{
			return 0;
		}
