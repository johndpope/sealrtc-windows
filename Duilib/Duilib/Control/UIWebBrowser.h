...
namespace DuiLib
{
	...
	protected:
		IWebBrowser2*			m_pWebBrowser2; //pointer of web browser
		...
		CDuiString m_sHomePage;	// home page
		bool m_bAutoNavi;	// wether auto-navi to home page
		CWebBrowserEventHandler* m_pWebBrowserEventHandler;	//web browser event handler
	...
	public:
		...
		// Duilib message send to WebBrowser
