...
public:
	...
	bool RemoveFromListBody(CControlUI* pControl);
	...
	bool IsNeedPaintBkColor() const;
	void SetNeedPaintBkColor(bool bNeedPaintBkColor = true);
...
public:
    ...
    void Invalidate(); // CControl::Invalidate  scroll bar will update£¬override to local update
    bool Activate();
...
class UILIB_API CListContainerElementUICallBack
{
public:
	virtual void BuildListElementUI(CListContainerElementUI* listElement) = 0;
};
...
public:
	...
	CListContainerElementUICallBack* GetCallBack() const { return m_listContainerElementCallBack; }
	void SetCallBack(CListContainerElementUICallBack* val) { m_listContainerElementCallBack = val; }
...
protected:
    ...
    UINT m_uButtonState;
    IListOwnerUI* m_pOwner;
	CListContainerElementUICallBack* m_listContainerElementCallBack;
	bool m_isListContainerElementBuilded;
};
